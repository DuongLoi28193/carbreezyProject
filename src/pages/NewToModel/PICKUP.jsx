    ...
    const cars = [
        {
            id: "39",
            brand: "MAZDA",
            name: "Mazda BT-50 3.0L Double Cab 4WD Premium Pickup",
            model: "PICKUP",
            price: 42000,
            seats: "5 seats",
            fuel: "Diesel",
        ...
        },
        {
            id: "31",
            brand: "FORD",
            name: "Ford Ranger XLS 2.2L 4x2 Automatic Pickup 2019",
            model: "PICKUP",
            price: 25000,
            seats: "5 seats",
            fuel: "Diesel",
        ...
        },
        {
            id: "04",
            brand: "Ford",
            name: "Ford Ranger XLS 2.2L 4x2 Automatic Pickup 2020",
            model: "PICKUP",
            price: 23520,
            seats: "7 seats",
            fuel: "Diesel",
        ...
        <div>
            ...
            <div className="container_brand-model__search">
                ...
                <div className="brands_search">
                    ...
                    <div className='box-brand_item'>
                        ...
                        <span className='line-vertical'>|</span>
                        <Link style={{ color: "#BD1919", fontWeight: "bold", textDecoration: "underline" }} to="/newCar">PICKUP</Link>
                        <span className='line-vertical'>|</span>
            ...
            <div className="car-menu" >
                <div className="car-grid center-temp">
                    {cars.map((car) => (
                        <div onClick={() => nav(`/newCar/PICKUP/${car.id}`)} className="car-item_menu" key={car.id}>
                            <img
                                src={car.imgSrc}
                                alt={car.name}
