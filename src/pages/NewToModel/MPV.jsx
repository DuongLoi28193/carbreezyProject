    ...
    const cars = [
        {
            id: "36",
            brand: "HONDA",
            name: "Honda BR-V 1.5L Premium Edition",
            model: "MPV",
            price: 32500,
            seats: " 7 seats",
            fuel: "Gasoline",
        ...
        },
        {
            id: "37",
            brand: "FORD",
            name: "Ford Tourneo Titanium 2.0L Premium Edition",
            model: "MPV",
            price: 45000,
            seats: "7 seats",
            fuel: "Gasoline",
        ...
        },
        {
            id: "38",
            brand: "KIA",
            name: "Kia Sedona 2.2L Premium Edition",
            model: "MPV",
            price: 39580,
            seats: "7 seats",
            fuel: "Gasoline",
        ...
        },
        {
            id: "15",
            brand: "KIA",
            name: "Kia Rondo GAT 1.6L Premium Edition 2022",
            model: "MPV",
            price: 21666,
            seats: "7 seats",
            fuel: "Gasoline",
        ...
        <div>
            ...
            <div className="container_brand-model__search">
                ...
                <div className="brands_search">
                    ...
                    <div className='box-brand_item'>
                        ...
                        <span className='line-vertical'>|</span>
                        <Link style={{ color: "#BD1919", fontWeight: "bold", textDecoration: "underline" }} to="/newCar">MPV</Link>
                        <span className='line-vertical'>|</span>
            ...
            <div className="car-menu" >
                <div className="car-grid center-temp">
                    {cars.map((car) => (
                        <div onClick={() => nav(`/newCar/MPV/${car.id}`)} className="car-item_menu" key={car.id}>
                            <img
                                src={car.imgSrc}
                                alt={car.name}
