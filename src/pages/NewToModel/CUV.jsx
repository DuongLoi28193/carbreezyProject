    ...
    const cars = [
        {
            ...
            length: "4630 mm",
            color: "White",
            imgSrc: "ford21.jpg", // Chỉ giữ tên tệp
            year: 2023,
            newPrice: 30000,
            power: "118 kW"
        },
    ...
    return (
        <div>
            ...
            <div style={{ marginBottom: "-10px" }} className='nav-page'>
                ...
                <svg className='chevron-right' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="car-grid center-temp">
                    {cars.map((car) => (
                        <div onClick={() => nav(`/newCar/CUV/${car.id}`)} className="car-item_menu" key={car.id}>
                            <img
                                src={process.env.PUBLIC_URL + `/img/${car.imgSrc}`} 
                                alt={car.name}
