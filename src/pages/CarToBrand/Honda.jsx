...
import { faGasPump, faCogs, faTags, faCar, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    <div>
      ...
      <div className="car-menu" >
        <div className="car-grid center-temp">
          {cars.map((car) => (
            <div onClick={() => nav(`/honda/${car.id}`)} className="car-item_menu" key={car.id}>
              <img
                src={car.imgSrc}
                alt={car.name}
