                ...
                {dataItem && Array.isArray(dataItem.imgSrc) && dataItem.imgSrc.length > 0 ? (
                    <div className="container__car-detail">
                        ...
                        <div className="box_info-car">
                            ...
                            <p className="priceCar__details">${dataItem.newPrice}</p>
                            <div className='box-extra_icon-price detail-used' style={{ textDecoration: "line-through", marginTop: "-10px", marginBottom: "20px" }}>
                                <FontAwesomeIcon className='iconTags__details' icon={faTags} />${dataItem.price} (Price with DPH)
                            </div>
