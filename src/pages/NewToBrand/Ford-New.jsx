    ...
    <div>
      ...
      <div className="container_brand-model__search">
        <div className="brands_search">
          ...
          <div className='box-brand_item'>
            ...
            <span className='line-vertical'>|</span>
            <Link style={{ color: "#BD1919", fontWeight: "bold", textDecoration: "underline" }} to="/newCar">FORD</Link>
            <span className='line-vertical'>|</span>
      ...
      <div className="car-menu" >
        <div className="car-grid center-temp">
          {cars.map((car) => (
            <div onClick={() => nav(`/newCar/ford/${car.id}`)} className="car-item_menu" key={car.id}>
              <img
                src={car.imgSrc}
                alt={car.name}
