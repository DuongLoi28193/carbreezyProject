...
import { faGasPump, faCogs, faCalendarAlt, faCar, faTags, faSearch } from '@fortawesome/free-solid-svg-icons';
    ...
    <div>
      ...
      <div className="container_brand-model__search">
        <div className="brands_search">
          ...
          <div className='box-brand_item'>
            ...
            <Link style={{ color: "#BD1919", fontWeight: "bold", textDecoration: "underline" }} to="/newCar">KIA</Link>
            <span className='line-vertical'>|</span>
      ...
      <div className="car-menu" >
        <div className="car-grid center-temp">
          {cars.map((car) => (
            <div onClick={() => nav(`/newCar/kia/${car.id}`)} className="car-item_menu" key={car.id}>
              <img
                src={car.imgSrc}
                alt={car.name}
